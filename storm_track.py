...
def storm_track(wrfout_pattern: str) -> xr.Dataset:
    ...
    pressure value. slp is not available as a variable, but has to be calculated form wrf-python.
...
if __name__ == "__main__":
    ...
    pattern = f"/cluster/home/{args.user}/wcm/wrf-model/wrf-output/era5_default/wrfout_d01_*"
